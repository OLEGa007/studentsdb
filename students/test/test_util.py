...
class UtilsTestCase(TestCase):
    ...
    def setUp(self):
        # create student for assigning a leader
    ...
    def test_get_groups(self):
        ...
        # test with no groups in database
        print(Group.objects.all()[0].leader)
        group = Group.objects.all()[0]
        group.leader = None
        group.save()
        print(Student.objects.all()[0])
        print(Group.objects.all()[0].leader)
